                ...
                >
                  ...
                  >
                    ...
                    <p
                      ...
                      class="hidden font-normal dark:text-gray-400 text-base leading-6 text-zinc-700 mt-4 w-11/12"
                    >
                      El repartidor hará todo lo posible por comunicarse con el
                      cliente. En caso de no poder, puede realizar otra visita
                      en otra hora del día o regresará el paquete a la dirección
                      de origen. (Esto genera una multa al costo de envío).
                    </p>
                  </div>
                  <div
                  ...
                  >
                    ...
                    <p
                      ...
                      class="hidden font-normal dark:text-gray-400 text-base leading-6 text-zinc-700 mt-4 w-11/12"
                    >
                      Los transportistas no garantizan los plazos de entrega en
                      sentido estricto. Cuando garantizan un plazo de entrega,
                      significa que se comprometen a poner en práctica todos los
                      medios para respetar el plazo anunciado, y que en caso de
                      retraso imputable a ellos, pueden reembolsar una parte o
                      el conjunto de los gastos de envío según la oferta
                      adoptada.
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  >
                    ...
                    <p
                      ...
                      class="hidden font-normal dark:text-gray-400 text-base leading-6 text-zinc-700 mt-4 w-11/12"
                    >
                      Tienes hasta 30 días después de haber realizado tu compra.
                    </p>
                  </div>
                </div>
              </div>
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      tienda online Lazzy Buy; debes ponerte en contacto con el
                      área de servicio al cliente LAZZYBUY, dentro de los (10)
                      10 días de haber recibido tu pedido.
                    </p>
                  </div>
                  <div
                    className="flex justify-between items-center cursor-pointer"
                  ...
                  >
                    ...
                    <p
                      ...
                      class="hidden font-normal dark:text-gray-400 text-base leading-6 text-gray-600 mt-4 w-11/12"
                    >
                      Si, tedras un plazo maximo de10 días habiles para realizar
                      tu petición de cambio de producto.
                    </p>
                  </div>
                  <div
                    className="flex justify-between items-center cursor-pointer"
                  ...
                  >
                    ...
                    <p
                      ...
                      class="hidden font-normal dark:text-gray-400 text-base leading-6 text-gray-600 mt-4 w-11/12"
                    >
                      Si, nuestras normas te permiten realizar más de un cambio
                      de producto, pero al tercer cambio se cobrará una tarifa
                      adicional.
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  >
                    ...
                    <p
                      ...
                      class="hidden font-normal dark:text-gray-400 text-base leading-6 text-zinc-700 mt-4 w-11/12"
                    >
                      Sí, por supuesto. Tienes la opción desde la página web de
                      Carryt registrarte y agregar el código para rastrear en
                      tiempo real el paquete que recibirás.
                    </p>
                  </div>
                </div>
              </div>

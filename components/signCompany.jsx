            ...
            <div className="w-fullbg-gradient-to-t to-zinc-400 from-fondo-200 p-5">
              ...
              <div className="mt-6">
                ...
                <div className="mt-3 md:flex md:items-center md:-mx-2">
                  <button disabled={typeAccount.company ? true : null}
                  ...
                  <button className="mt-1 flex justify-center w-full px-6 py-3 text-zinc-100 font-bold bg-zinc-400 hover:bg-gradient-to-tl hover:to-zinc-400 hover:from-fondo-200 border-fondo-200 rounded-md md:w-auto md:mx-2 focus:outline-none" onClick={handleClick}>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="w-6 h-6"
                      fill="none"

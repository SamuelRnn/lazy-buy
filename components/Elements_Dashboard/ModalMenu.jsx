    ...
    <AnimatePresence>
      {showModal && (
        <motion.div
          ...
          animate="visible"
          exit="hidden"
          className="bg-fondo-300 w-[90%] gap-2 left-5 rounded-lg absolute mt-8 h-[100px] flex flex-col items-center justify-center text-white font-semibold py-20 over md:hidden"
